...
Hero9.defaultProps = {
  action2: 'Contact Us',
  action1: 'See Our Work',
  heading1: 'Welcome to BlueGreen Productions',
  image1Src:
    'https://images.unsplash.com/photo-1518893494013-481c1d8ed3fd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxODU2NjU1OXw&ixlib=rb-4.0.3&q=80&w=1080',
  content1:
    'Your go-to destination for high-quality YouTube video production services.',
  image1Alt: 'BlueGreen Productions Logo',
}
